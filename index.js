...
try {
  ...
  var supportsColor = __nccwpck_require__(1894);
...
var Buffer = __nccwpck_require__(6220).Buffer;
...
var modules = [
    ...
    __nccwpck_require__(1178),
    __nccwpck_require__(4280),
    __nccwpck_require__(1249),
    __nccwpck_require__(1263),
    __nccwpck_require__(8261),
    __nccwpck_require__(7362),
];
...
var bomHandling = __nccwpck_require__(4666),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __nccwpck_require__(7290); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __nccwpck_require__(3048)(iconv);
    }

    // Load Node primitive extensions.
    __nccwpck_require__(6152)(iconv);
}
...
module.exports = function(charset) {
  try {
    if (!iconv) iconv = __nccwpck_require__(6513);
  } catch(e) {
    /* iconv not found */
  }
...
var fs          = __nccwpck_require__(5747),
    ...
    stream      = __nccwpck_require__(2413),
    debug       = __nccwpck_require__(7015)('needle'),
    stringify   = __nccwpck_require__(6069)/* .build */ .J,
    multipart   = __nccwpck_require__(9505),
    auth        = __nccwpck_require__(8519),
    cookies     = __nccwpck_require__(4261),
    parsers     = __nccwpck_require__(526),
    decoder     = __nccwpck_require__(3834);
...
var extend = Object.assign ? Object.assign : __nccwpck_require__(1669)._extend;
...
var sax = __nccwpck_require__(947);
...
var needle = __nccwpck_require__(7479);


needle('post', 'http://api.bq04.com/apps', { "type": "android", "bundle_id": "com.smallraw.foretime.app", "api_token": "64125cf785406b8d1ac58d282ee4bd03" }, { json: true })
